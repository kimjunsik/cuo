<%@page import="cuo.web.board.vo.ReplyInfo"%>
...
<%
	...
	int postNum = replyInfo.getPostNum();
		...
		<form action="boardWritePro.bo" method = "post">
			...
			<table>
				<tr>
					...
					<td class = "td_right">
						<input type = "text" name ="postWriter" id ="postWriter"/>
					</td>
				</tr>
				...
				<tr>
					...
					%>
						<input type = "text" name ="postTitle" id="postTitle" value = "[답변]"/>
					<%
						}
						else{
					%>
				...
				<tr>
					...
					<td class = "td_right">
						<textarea name ="postContent" id ="postContent" rows="10" cols="15"></textarea>
					</td>
				</tr>
