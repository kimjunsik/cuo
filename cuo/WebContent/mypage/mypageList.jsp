        ...
        <div class="col-md-4">
            <div class="panel panel-success">
                ...
                <div class="panel-footer">
                    <a href ="myOrderList.mp" class="btn btn-lg btn-block btn-success">더보기</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="panel panel-info">
                ...
                <div class="panel-footer">
                    <a class="btn btn-lg btn-block btn-info">더보기</a>
                </div>
            </div>
        </div>
    </div>
