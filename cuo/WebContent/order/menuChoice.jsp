   ...
   <div id="wrapper">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <p>
        ...
        <button type="button" class="btn btn-lg btn-default">중식</button>
        </a>
       <a href = "menuName.or?menuKey=<%=orderList.get(1).getMenuKey()%>">
        <button type="button" class="btn btn-lg btn-primary">일식</button></a>
        <%--  <a href = "menuName.or?menuKey=<%=orderList.get(2).getMenuKey()%>">
        <button type="button" class="btn btn-lg btn-success">족발</button></a>
        <a href = "menuName.or?menuKey=<%=orderList.get(3).getMenuKey()%>">
        <button type="button" class="btn btn-lg btn-info">보쌈</button></a>
        <a href = "menuName.or?menuKey=<%=orderList.get(4).getMenuKey()%>">
        <button type="button" class="btn btn-lg btn-warning">치킨</button></a>
        <a href = "menuName.or?menuKey=<%=orderList.get(5).getMenuKey()%>">
        <button type="button" class="btn btn-lg btn-danger">기타</button></a>
