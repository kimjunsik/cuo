...
<section id = "logo">
     <a href = "maindex.jsp"><img src="imgs/logo3.png" width="250" height="100" align="middle"/></a>
</section>
<section>
...
<div class="container">
    <div class="row colored">
        <div id="contentdiv" class="contcustom">
            ...
            <h2>Login</h2>
            <div>
                <input id="id" name = "id" type="text" placeholder="username" onkeypress="check_values();">
                <input id="passwd" name="passwd" type="password" placeholder="password" onkeypress="check_values();">
                <input type = "submit" value = "로그인" style="background-color:lightgray;"/>
